...
pub fn main() void {
    ...
    if (tex) |t| {
        ...
        _ = zsdl3.setTextureColorMod(t, .{ .r = 200, .g = 200, .b = 255 });
    }
    ...
    while (running) {
        ...
        _ = zsdl3.setRenderDrawColor(renderer, .{ .r = 100, .g = 255, .b = 100 });
        _ = zsdl3.renderLine(renderer, 20, 62, 200, 62);

        _ = zsdl3.setRenderDrawColor(renderer, .{ .r = 100, .g = 100, .b = 255 });
        _ = zsdl3.renderRect(renderer, &.{ .x = 20, .y = 78, .w = 160, .h = 48 });

        _ = zsdl3.setRenderDrawColor(renderer, .{ .r = 200, .g = 200, .b = 50 });
        _ = zsdl3.renderFillRect(renderer, &.{ .x = 20, .y = 138, .w = 160, .h = 50 });

        _ = zsdl3.setRenderDrawColor(renderer, .{ .r = 50, .g = 200, .b = 200 });
        ...
        _ = zsdl3.setRenderDrawColor(renderer, .{ .r = 25, .g = 45, .b = 25 });
        _ = zsdl3.renderClear(renderer);

        // Draw viewport-relative coordinates (origin = viewport top-left)
        _ = zsdl3.setRenderDrawColor(renderer, .{ .r = 255, .g = 80, .b = 80 });
        ...
        _ = zsdl3.setRenderDrawColor(renderer, .{ .r = 180, .g = 180, .b = 180 });
